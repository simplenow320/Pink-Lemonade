  ...
  switch (iconName) {
    case 'dashboard':
      return (
        ...
        >
          <path
            d="M4 5a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5z"
            fill="currentColor"
            opacity="0.2"
          />
          <path
            d="M13 5a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1h-5a1 1 0 01-1-1V5z"
            fill="currentColor"
            opacity="0.2"
          />
          <path
            d="M4 13a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1v-5z"
            fill="currentColor"
            opacity="0.2"
          />
          <path
            d="M13 13a1 1 0 011-1h5a1 1 0 011 1v5a1 1 0 01-1 1h-5a1 1 0 01-1-1v-5z"
            fill="currentColor"
            opacity="0.2"
          />
          <path
            d="M5 4a1 1 0 00-1 1v5a1 1 0 001 1h5a1 1 0 001-1V5a1 1 0 00-1-1H5zM14 4a1 1 0 00-1 1v5a1 1 0 001 1h5a1 1 0 001-1V5a1 1 0 00-1-1h-5zM5 12a1 1 0 00-1 1v5a1 1 0 001 1h5a1 1 0 001-1v-5a1 1 0 00-1-1H5zM14 12a1 1 0 00-1 1v5a1 1 0 001 1h5a1 1 0 001-1v-5a1 1 0 00-1-1h-5z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case 'organization':
      return (
        ...
        >
          ...
          />
          <path
            d="M15 14H9C6.79086 14 5 15.7909 5 18V20H19V18C19 15.7909 17.2091 14 15 14Z"
            fill="currentColor"
            opacity="0.2"
          />
          <path
          ...
          />
          <path
            d="M17 20H22V18C22 16.3431 20.6569 15 19 15C18.0444 15 17.1931 15.4468 16.6438 16.1429M15 14H9C6.79086 14 5 15.7909 5 18V20H19V18C19 15.7909 17.2091 14 15 14ZM12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case 'chart':
      return (
        ...
        >
          ...
          <path
            d="M3 13H7V21H3V13ZM10 8H14V21H10V8ZM17 3H21V21H17V3Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case 'pen':
      return (
        ...
        >
          <path
            d="M15.2322 5.23223L18.7677 8.76777L7.76777 19.7678L4.23223 16.2322L15.2322 5.23223Z"
            fill="currentColor"
            opacity="0.2"
          />
          <path
