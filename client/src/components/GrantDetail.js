...
const GrantDetail = () => {
  ...
  const statusOptions = ['Not Started', 'In Progress', 'Submitted', 'Won', 'Declined'];
      ...
      {isEditing ? (
        <div className="bg-white shadow overflow-hidden rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            <h3 className="text-lg leading-6 font-medium text-gray-900">Edit Grant Details</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white shadow overflow-hidden rounded-lg">
              <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Grant Details</h3>
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  {grant.is_scraped && (
                      ...
                      <div className="border rounded-md p-3 bg-gray-50">
                        ...
                        grant.contact_info ? (
                          <div className="mt-2 space-y-1">
                            {grant.contact_name && (
                              <p>
                                <span className="font-medium">Name:</span> {grant.contact_name}
                              </p>
                            )}
                            {grant.contact_email && (
                              <p>
                        ...
                        {grant.submission_url || grant.application_process || grant.grant_cycle ? (
                          <div className="mt-2 space-y-1">
                            {grant.submission_url && (
                              <p>
                                <span className="font-medium">Submit at:</span>{' '}
                                <a
                            ...
                            {grant.grant_cycle && (
                              <p>
                                <span className="font-medium">Grant Cycle:</span>{' '}
                                {grant.grant_cycle}
                              </p>
                            )}
                          </div>
          ...
          <div className="md:col-span-1 space-y-6">
            <div className="bg-white shadow overflow-hidden rounded-lg">
              <div className="px-4 py-5 sm:px-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Organization Match</h3>
              </div>
              <div className="px-4 py-5 sm:p-6">
                <div className="mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-sm font-medium ${getMatchScoreClass(grant.match_score)}`}
                    >
                ...
                <div className="mt-6">
                  ...
                  <p className="text-sm text-gray-700 whitespace-pre-line">
                    {grant.match_explanation ||
                      'No match analysis available. Click "Calculate Match" to analyze this grant against your organization profile.'}
                  </p>
                </div>
            ...
            <div className="bg-white shadow overflow-hidden rounded-lg">
              <div className="px-4 py-5 sm:px-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Grant Timeline</h3>
              </div>
              <div className="px-4 py-5 sm:p-6">
                <ol className="border-l-2 border-primary">
                  ...
                  <li className="ml-6 mb-6">
                    <span
                      className={`absolute flex items-center justify-center ${grant.status === 'Not Started' ? 'bg-primary' : 'bg-gray-200'} text-white rounded-full h-6 w-6 -ml-10`}
                    >
                      <svg
                        className="h-3 w-3"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className="ml-6 mb-6">
                    <span
                      className={`absolute flex items-center justify-center ${grant.status === 'Submitted' ? 'bg-primary' : 'bg-gray-200'} text-white rounded-full h-6 w-6 -ml-10`}
                    >
                      <svg
                        className="h-3 w-3"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className="ml-6">
                    <span
                      className={`absolute flex items-center justify-center ${grant.status === 'Won' || grant.status === 'Declined' ? 'bg-primary' : 'bg-gray-200'} text-white rounded-full h-6 w-6 -ml-10`}
                    >
                      <svg
                        className="h-3 w-3"
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Delete Grant</h3>
                    <div className="mt-2">
