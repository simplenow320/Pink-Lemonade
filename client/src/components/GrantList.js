      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="md:col-span-2">
            <label htmlFor="search" className="block text-sm font-medium text-gray-700">Search Grants</label>
                ...
                <div className="px-6 py-4 flex flex-col md:flex-row md:items-center">
                  ...
                  <div className="mt-4 md:mt-0 flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className={`text-sm font-semibold ${getMatchScoreClass(grant.match_score)}`}>
        ...
        <div className="bg-white shadow rounded-lg p-10 text-center">
          {searchTerm || filters.status ? (
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Try different search terms or filter criteria.</p>
              <div className="mt-6">
                <button
                  type="button"
                  onClick={() => {
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Get started by adding a new grant or running the grant scraper.</p>
              <div className="mt-6">
                <Link
                  to="/grants/upload"
