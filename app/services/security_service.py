...
class SecurityService:
    ...
    def add_security_headers(cls, response):
        ...
        response.headers['Content-Security-Policy'] = "default-src 'self' data: https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https:;"
        return response
